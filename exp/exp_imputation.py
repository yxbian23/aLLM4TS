...
from models import LLM4TS_imputation
...
class Exp_Imputation(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {
            'LLM4TS_imputation': LLM4TS_imputation,
        }
        ...
        if self.args.pt_sft:
            ...
            if self.args.model == "LLM4TS_imputation" :
    ...
    def test(self, setting, test=0):
        ...
        if not os.path.exists(folder_path):
            os.makedirs(folder_path)
        mae, mse, rmse, mape, mspe, rse = metric(preds[masks == 0], trues[masks == 0])
