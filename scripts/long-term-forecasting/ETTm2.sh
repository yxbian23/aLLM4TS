...
if [ ! -d "./logs/long-term-forecasting/ETTm2" ]; then
    mkdir ./logs/long-term-forecasting/ETTm2
fi

if [ ! -d "./checkpoints/long-term-forecasting/ETTm2" ]; then
    mkdir ./checkpoints/long-term-forecasting/ETTm2
fi
...
do
    ...
    --history_len 336 \
    --checkpoints ./checkpoints/long-term-forecasting/ETTm2 \
    > logs/long-term-forecasting/ETTm2/$model_id'_336_'$pred_len'_llml'$llm_layers'_lr'$lr'_bs'$bs'_'$exp_des.log 2>&1 
done
done
done
done
