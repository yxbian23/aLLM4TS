...
if [ ! -d "./logs/long-term-forecasting/weather" ]; then
    mkdir ./logs/long-term-forecasting/weather
fi

if [ ! -d "./checkpoints/long-term-forecasting/weather" ]; then
    mkdir ./checkpoints/long-term-forecasting/weather
fi
