...
if [ ! -d "./logs/long-term-forecasting/traffic" ]; then
    mkdir ./logs/long-term-forecasting/traffic
fi

if [ ! -d "./checkpoints/long-term-forecasting/traffic" ]; then
    mkdir ./checkpoints/long-term-forecasting/traffic
fi
